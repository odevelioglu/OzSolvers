...
{
    //http://latkin.org/blog/2012/03/20/how-to-calculate-1-million-digits-of-pi/
    public class HighPrecision
    {
        ...
        public override string ToString()
        {
            ...
            BigInteger remain;
            var quotient = BigInteger.DivRem(num, HighPrecision.denom, out remain);
            var integerDigits = quotient.IsZero ? 1 : (int)BigInteger.Log10(quotient) + 1;
            sb.Append(quotient.ToString());

            int i = 0;
            var smallDenom = HighPrecision.denom / 10;
        ...
        public static string Print(BigInteger num, BigInteger denom, int precision)
        {
            var sb = new StringBuilder();
